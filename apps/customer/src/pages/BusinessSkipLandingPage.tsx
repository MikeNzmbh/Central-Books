        ...
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-500 max-w-xl">
              You can start exploring Clover Books now. We’ll keep your unfinished setup in the background until you’re ready.
            </p>
          </div>
        </div>
      </header>
            ...
            <aside className="space-y-4 md:space-y-5">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-900 text-slate-50 shadow-sm px-4 py-4 md:px-5 md:py-5 space-y-3">
                ...
                <p className="text-xs text-slate-200/85">
                  It’s okay to try things before everything is perfect. Clover Books keeps drafts and test data separate
