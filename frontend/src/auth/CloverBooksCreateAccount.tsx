        ...
        <section className="bg-white/95 backdrop-blur rounded-3xl shadow-lg border border-slate-100 px-7 sm:px-9 py-8 sm:py-10 flex flex-col justify-center">
          ...
          <form method="post" action={action} className="space-y-4">
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2.5 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50"
            >
