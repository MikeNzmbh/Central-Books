                ...
                <div className="divide-y divide-slate-100">
                  {filteredCustomers.length === 0 && (
                    <div className="flex flex-col items-center justify-center gap-2 px-5 py-10 text-center text-xs text-slate-400">
                      ...
                      <a href="/customers/new/" className="text-slate-900 hover:underline">Create a new customer</a>
                    </div>
                  )}
                  ...
                  {activeTab === 'overview' && (
                    <>
                      ...
                      <div className="grid gap-3 md:grid-cols-2">
                        ...
                        <div className="rounded-2xl bg-indigo-50/50 p-3 ring-1 ring-indigo-200">
                          <div className="mb-2 flex items-center justify-between text-[11px] text-indigo-700">
                            <span>Companion notes</span>
                            <Sparkles className="h-3 w-3" />
                          </div>
                          <p className="rounded-xl bg-white px-3 py-2 text-[11px] text-slate-600 ring-1 ring-indigo-100">
                                ...
                                >
                                  ...
                                  {canApply && (
                                    <button
                                      ...
                                      className="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900 text-[11px] font-medium text-white hover:bg-slate-800 transition-colors"
                                    >
                                      Apply
                                    </button>
                                  )}
            ...
            <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl ring-1 ring-slate-200">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-200"
                    placeholder="0.00"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-16 px-3 py-2 text-sm border border-slate-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-slate-200"
              ...
              <div className="flex gap-2 mt-5">
                ...
                <button
                  ...
                  className="flex-1 h-10 rounded-xl bg-slate-900 text-xs font-medium text-white hover:bg-slate-800 transition-colors"
                >
                  Record Payment
                </button>
              </div>
