...
export interface CompanionSuggestionBannerProps {
    ...
    isLlmSubtitle?: boolean; // true if subtitle came from DeepSeek AI
                ...
                <div className="flex flex-1 items-start gap-4">
                    <div className="space-y-1 flex-1">
                        ...
                        <div className="text-xs text-slate-600 flex items-center gap-1.5">
                            ...
                            <span
                                className={`ml-1 inline-flex items-center gap-0.5 rounded-full px-1.5 py-0.5 text-[10px] font-medium ${isLlmSubtitle
                                    ? "bg-blue-50 text-blue-700 border border-blue-200"
                                    : "bg-slate-50 text-slate-500 border border-slate-200"
                                    }`}
                                title={isLlmSubtitle ? "Generated by AI Companion" : "Calculated automatically"}
                            >
                                {isLlmSubtitle ? "✨ AI" : "📊 Auto"}
                            </span>
                        </div>
